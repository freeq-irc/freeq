...
pub struct AgentSurfaces {
    ...
    /// needs to be told that rather than left to fail.
    pub mcp_source: &'static str,
    /// Whether `mcp_package` can be installed from the public npm registry yet.
    pub mcp_published: bool,
