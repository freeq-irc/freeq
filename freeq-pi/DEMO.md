...
- **Handoffs are not implemented.** Durable delegation that survives the
  recipient being offline is M4 — the design's headline capability, not yet
  built. v0.1 is presence + ask + rooms.
