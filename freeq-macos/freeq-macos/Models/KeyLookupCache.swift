...
/// in Application Support rather than the Keychain, which the device key
/// needs and this does not, and needs no account to name it.
final class FileKeyLookupStore: KeyLookupStore {

    private static let log = Logger(subsystem: "at.freeq.macos", category: "keylookup")
